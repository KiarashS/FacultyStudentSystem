...
{
    public partial class AcademicRankController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected AcademicRankController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AcademicRankController Actions { get { return MVC.Dashboard.AcademicRank; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Dashboard";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "AcademicRank";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "AcademicRank";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AcademicRankController : ContentManagementSystem.Web.Areas.Dashboard.Controllers.AcademicRankController
    {
        public T4MVC_AcademicRankController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ContentManagementSystem.Models.ViewModels.AcademicRankViewModel rank);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(ContentManagementSystem.Models.ViewModels.AcademicRankViewModel rank)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "rank", rank);
            CreateOverride(callInfo, rank);
            return callInfo;
        }

        [NonAction]
        partial void UpdateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ContentManagementSystem.Models.ViewModels.AcademicRankViewModel rank);

        [NonAction]
        public override System.Web.Mvc.ActionResult Update(ContentManagementSystem.Models.ViewModels.AcademicRankViewModel rank)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Update);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "rank", rank);
            UpdateOverride(callInfo, rank);
            return callInfo;
        }
