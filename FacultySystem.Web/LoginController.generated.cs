...
namespace ContentManagementSystem.Web.Controllers
{
    public partial class LoginController
    {
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string Index_v1 = "Index-v1";
                public readonly string Index = "Index";
            }
            public readonly string Index_v1 = "~/Views/Login/Index-v1.cshtml";
            public readonly string Index = "~/Views/Login/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_LoginController : ContentManagementSystem.Web.Controllers.LoginController
    {
        ...
        [NonAction]
        partial void LogonOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string email, string password, string captchaInputText, string returnUrl);

        [NonAction]
        public override System.Web.Mvc.ActionResult Logon(string email, string password, string captchaInputText, string returnUrl)
        {
            ...
            LogonOverride(callInfo, email, password, captchaInputText, returnUrl);
            return callInfo;
        }
