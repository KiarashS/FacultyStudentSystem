...
namespace ContentManagementSystem.Web.Controllers
{
    public partial class NewsController
    {
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _NewsList = "_NewsList";
                public readonly string Detail = "Detail";
                public readonly string Index = "Index";
            }
            public readonly string _NewsList = "~/Views/News/_NewsList.cshtml";
            public readonly string Detail = "~/Views/News/Detail.cshtml";
            public readonly string Index = "~/Views/News/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_NewsController : ContentManagementSystem.Web.Controllers.NewsController
    {
