...
//namespace ContentManagementSystem.Commons.Web.Report
//{
...
//        {
//            get { return new List<BaseColor> { new BaseColor(ColorTranslator.FromHtml("#f5f5f5").ToArgb()), new BaseColor(ColorTranslator.FromHtml("#b4b5b7").ToArgb()) }; }
//        }
