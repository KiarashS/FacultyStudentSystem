...
namespace ContentManagementSystem.Commons.Web.HttpCompress
{
    public sealed class Settings
    {
        ...
        {
            Settings settings = (Settings)System.Configuration.ConfigurationManager.GetSection("blowery.web/httpCompress");
            if (settings == null)
