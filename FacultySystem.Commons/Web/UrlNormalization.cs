...
            };
        ...
        public static string NormalizeUrl(this Uri uri, bool convertToLowercase = true)
        {
            string url = uri.ToString();
            if (convertToLowercase) url = UrlToLower(uri);
        ...
        public static string NormalizeUrl(this string url , bool convert = true)
        {
            return NormalizeUrl(new Uri(url), convert);
        }
