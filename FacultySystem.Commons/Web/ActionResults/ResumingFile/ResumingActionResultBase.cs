...
namespace ContentManagementSystem.Commons.Web.ActionResults.ResumingFile
{
    public abstract class ResumingActionResultBase : ActionResult
    {
        ...
        public string FileDispositionType { get; set; }
        public string FileName { get; set; }

        protected ResumingActionResultBase(string contentType, string fileDispositionType = "attachment", string fileName = "download")
        {
            if (string.IsNullOrEmpty(contentType))
                throw new ArgumentException();

            this.ContentType = contentType;
            this.FileDispositionType = fileDispositionType;
        ...
        protected virtual void WriteCommonHeaders(ControllerContext context, ResumingRequest resumingRequest)
        {
            ...
            {
                context.HttpContext.Response.AddHeader(
                    "Content-Disposition", string.Format("{0}; filename=\"{1}\"", FileDispositionType, FileName));
            }
